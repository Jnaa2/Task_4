...
describe('Authentication controller integration', () => {
  ...
  test('authenticates the same user and issues a JWT', async () => {
    ...
    // It’s fine if this token is the same as the registration token.
    // We just store it for the /auth/me test.
    issuedToken = payload.token;
  });
